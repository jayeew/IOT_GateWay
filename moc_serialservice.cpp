...
QT_MOC_LITERAL(1, 14, 20), // "receiveMsgFromSerial"
QT_MOC_LITERAL(2, 35, 0), // ""
QT_MOC_LITERAL(3, 36, 14) // "readFromSerial"

    },
    "SerialService\0receiveMsgFromSerial\0\0"
    "readFromSerial"
};
...
void SerialService::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (SerialService::*_t)(QByteArray );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SerialService::receiveMsgFromSerial)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject SerialService::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_SerialService.data,
      qt_meta_data_SerialService,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
